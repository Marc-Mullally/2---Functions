...
func progressUpdate(steps : Int, goal: Int) {
    if ((Double(steps)/Double(goal)*100) <= 10) {
        print("You're off to a good start.")
    } else if ((Double(steps)/Double(goal)*100 <= 50)) {
        print("You're almost halfway there!")
    } else if ((Double(steps)/Double(goal)*100 <= 90)) {
...
progressUpdate(steps: 2,goal: 3)
progressUpdate(steps: 2,goal: 12)
...
//:  Your fitness tracking app is going to help runners stay on pace to reach their goals. Write a function called pacing that takes four `Double` parameters called `currentDistance`, `totalDistance`, `currentTime`, and `goalTime`. Your function should calculate whether or not the user is on pace to hit or beat `goalTime`. If yes, print "Keep it up!", otherwise print "You've got to push it just a bit harder!"
func pacing2(currentDistance: Double, totalDistance : Double, currentTime : Double, goalTime : Double) {
    if (currentDistance/currentTime == totalDistance/goalTime) {
        print("Keep it up!")
    } else {
        print("You've got to push it just a bit harder!")
...
//:  Your fitness tracking app is going to help runners stay on pace to reach their goals. Write a function called pacing that takes four `Double` parameters called `currentDistance`, `totalDistance`, `currentTime`, and `goalTime`. Your function should calculate whether or not the user is on pace to hit or beat `goalTime`. If yes, print "Keep it up!", otherwise print "You've got to push it just a bit harder!"
func pacing3(currentDistance: Double, totalDistance : Double, currentTime : Double, goalTime : Double) {
    if (currentDistance/currentTime == totalDistance/goalTime) {
        print("Keep it up!")
    } else {
        print("You've got to push it just a bit harder!")
